...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <a href="kategori.php" class="nav-item active"><?= icon('tags') ?><span class="label">Kategori Barang</span></a>
        <a href="users.php" class="nav-item"><?= icon('users') ?><span class="label">Data Pengguna</span></a>
